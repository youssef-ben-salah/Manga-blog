        ...
        <div style="display: flex;justify-items: flex-end;">
            ...
            <div style="margin:25px;font-family: UnifrakturMaguntia;">
                ...
                <div style="color: white;margin-top: 25px;">
                    ...
                    <p style="color: white;font-style: normal;">{!!@$the_manga->summary_ar!!}</p>
                </div>
                <div style="display:flex;justify-content: flex-end;margin-top:150px ; margin-bottom: 0px;">
                    
                    <div >
                        <a href="#"onclick="Like()">
                            <i class="fa fa-bookmark-o" aria-hidden="true"style="margin: 15px; color: red;"></i>
                        </a>
                    </div>
                    <div>
                        <a href="#"onclick="favorite()">
                            <i class="fa fa-thumbs-o-up" aria-hidden="true" style="margin: 15px;color: red;"></i>
                        </a>  
                    </div>
                </div>
            </div>
        ...
        <div >
            <center>
                ...
                <div style="height:15rem;">
                    <a href="{{route('chapter_Ar', ['id' => @$chapter->id])}}">
